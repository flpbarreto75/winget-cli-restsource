    ...
    public class Metrics
    {
            ...
            ILogger log)
        {
            ...
            var dimension = new Dictionary<string, string>
            {
                ...
                { "Route", path },
                { "Headers", JSONHelpers.FormatObjectToJSON(headers) },
                { "Object", JSONHelpers.FormatObjectToJSON(obj) },
                { "Error", JSONHelpers.FormatObjectToJSON(error) },
            };
            ...
            MetricNamespaces metricNamespaces = MetricNamespaces.MsPkgMgrProdLogs)
        {
            ...
            log.LogError(JSONHelpers.FormatObjectToJSON(icmDimensions));
